...
export default function HomeBenefits() {
  return (
    <section className="mt-14">
      <div className="mb-6">
        <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#8fa7c4]">Built for high-conviction buying</p>
        <h2 className="mt-2 text-3xl font-extrabold leading-tight text-white md:text-4xl">Why buyers use Full Hangar</h2>
        <p className="mt-3 max-w-3xl text-sm text-[#b5c0ce] md:text-base">Fast, data-backed decisions in a noisy market.</p>
      </div>
      <div className="grid gap-4 md:grid-cols-2">
        {BENEFITS.map((benefit) => (
          ...
          >
            ...
            <p className="mt-3 text-sm leading-relaxed text-[#d2dae6]">{benefit.description}</p>
